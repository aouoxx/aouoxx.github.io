---
layout: post
title: web基础知识cookie,session,filter,listener
categories: [web]
...
> _response 接口也定义了一个 addCookie 方法，它用于在其响应头中增加一个响应的 Set-Cookie 头字段。同样，request 接口中也定义了一个 getCookies 方法，它用于获取客户端提交的 Cookie_
...
> _设置 Cookie 的有效期为一天_ > _cookie.setMaxAge(24*60*60)_
